...
export type LauncherIconsBellIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function LauncherIconsBellIcon(props: LauncherIconsBellIconProps) {
...
export default LauncherIconsBellIcon;
/* prettier-ignore-end */
