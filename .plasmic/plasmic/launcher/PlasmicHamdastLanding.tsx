...
export type PlasmicHamdastLanding__ArgsType = { appKey?: string };
type ArgPropType = keyof PlasmicHamdastLanding__ArgsType;
export const PlasmicHamdastLanding__ArgProps = new Array<ArgPropType>("appKey");
              ...
              {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
                ...
                return (
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox___5Sfdc)}
                    key={currentIndex}
                  >
                    <CheckSvgIcon
...
const PlasmicDescendants = {
  root: ["root", "apiRequest", "img", "svg", "paziresh24Button"],
  apiRequest: ["apiRequest", "img", "svg", "paziresh24Button"],
  img: ["img"],
  svg: ["svg"],
