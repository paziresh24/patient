      ...
      <ApiRequest
        ...
        errorDisplay={
          <React.Fragment>
            {(() => {
              try {
                return $ctx?.auth?.info?.provider?.centers?.some(
                  item => item.id == "5532"
                );
              } catch (e) {
                if (
            ...
            {(() => {
              ...
              >
                <div className={classNames(projectcss.all, sty.freeBox__g495E)}>
                  <div
                    className={classNames(
                      projectcss.all,
        ...
        params={(() => {
          try {
            return {
              user_center_id: $ctx?.auth?.info?.provider?.centers?.find(
                item => item.id === "5532"
              ).user_center_id,
              server_id: 1
            };
        ...
        <div className={classNames(projectcss.all, sty.freeBox__wxcz5)}>
          {(() => {
            ...
            <div className={classNames(projectcss.all, sty.freeBox__vnEpp)}>
              <div className={classNames(projectcss.all, sty.freeBox__dyTj)} />
          ...
          {(() => {
            ...
            <div className={classNames(projectcss.all, sty.freeBox__bvg8K)}>
              <div className={classNames(projectcss.all, sty.freeBox__fd0Vr)} />
                      ...
                      args: [
                        ...
                        (() => {
                          try {
                            return {
                              user_center_id:
                                $state.apiRequest2.data.data[0].user_center_id,
                              can_booking: "0"
                            };
                          } catch (e) {
                            if (
...
const PlasmicDescendants = {
  root: ["root", "apiRequest2", "span", "_switch"],
