...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: 6w9lKEd-r02I/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__fsxw9)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__njWlm)}
              role={"img"}
            />
          ),
