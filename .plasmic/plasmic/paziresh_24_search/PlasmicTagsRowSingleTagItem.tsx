...
import sty from "./PlasmicTagsRowSingleTagItem.module.css"; // plasmic-import: umF0x1BStiqV/css
...
export type PlasmicTagsRowSingleTagItem__VariantMembers = {
  isSelected: "isSelected";
};
export type PlasmicTagsRowSingleTagItem__VariantsArgs = {
  isSelected?: SingleBooleanChoiceArg<"isSelected">;
};
type VariantPropType = keyof PlasmicTagsRowSingleTagItem__VariantsArgs;
export const PlasmicTagsRowSingleTagItem__VariantProps =
  new Array<VariantPropType>("isSelected");

export type PlasmicTagsRowSingleTagItem__ArgsType = {
  label?: string;
  name?: string;
  onClick?: (name: string) => void;
  onDelete?: (name: string) => void;
};
type ArgPropType = keyof PlasmicTagsRowSingleTagItem__ArgsType;
export const PlasmicTagsRowSingleTagItem__ArgProps = new Array<ArgPropType>(
  "label",
  "name",
  "onClick",
  "onDelete"
...
export type PlasmicTagsRowSingleTagItem__OverridesType = {
  root?: Flex__<"div">;
  sortIcon?: Flex__<"svg">;
  text?: Flex__<"div">;
  _delete?: Flex__<"div">;
...
export interface DefaultTagsRowSingleTagItemProps {
  label?: string;
  name?: string;
  onClick?: (name: string) => void;
  onDelete?: (name: string) => void;
...
function PlasmicTagsRowSingleTagItem__RenderFunc(props: {
  variants: PlasmicTagsRowSingleTagItem__VariantsArgs;
  args: PlasmicTagsRowSingleTagItem__ArgsType;
  overrides: PlasmicTagsRowSingleTagItem__OverridesType;
  forNode?: string;
}) {
  ...
  return (
    ...
    >
      ...
      {(() => {
        ...
        <Icon19Icon
          className={classNames(projectcss.all, sty.svg__b5Jv, {
            [sty.svgisSelected__b5Jv14N2G]: hasVariant(
              $state,
              "isSelected",
              "isSelected"
            )
      ...
      {(
        ...
        >
          <Icon13Icon
            className={classNames(projectcss.all, sty.svg__qfpXo, {
              [sty.svgisSelected__qfpXo14N2G]: hasVariant(
                $state,
                "isSelected",
                "isSelected"
              )
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicTagsRowSingleTagItem__OverridesType,
  DescendantsType<T>
>;
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicTagsRowSingleTagItem__ArgProps,
          internalVariantPropNames: PlasmicTagsRowSingleTagItem__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicTagsRowSingleTagItem__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicTagsRowSingleTagItem";
  } else {
    func.displayName = `PlasmicTagsRowSingleTagItem.${nodeName}`;
  }
  return func;
}

export const PlasmicTagsRowSingleTagItem = Object.assign(
  // Top-level PlasmicTagsRowSingleTagItem renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicTagsRowSingleTagItem
    internalVariantProps: PlasmicTagsRowSingleTagItem__VariantProps,
    internalArgProps: PlasmicTagsRowSingleTagItem__ArgProps
  }
);

export default PlasmicTagsRowSingleTagItem;
/* prettier-ignore-end */
