  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <meta key="og:title" property="og:title" content={PlasmicSearchPage.pageMetadata.title} />
        <meta key="twitter:title" name="twitter:title" content={PlasmicSearchPage.pageMetadata.title} />
      </Head>
...
const PlasmicDescendants = {
  ...
  freeBox: ['freeBox', 'suggestion', 'searchFilters', 'userLocation', 'mainSearchRequest'],
...
type NodeOverridesType<T extends NodeNameType> = Pick<PlasmicSearchPage__OverridesType, DescendantsType<T>>;
