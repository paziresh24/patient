...
import TagsRowSingleTagItem from "../../TagsRowSingleTagItem"; // plasmic-import: umF0x1BStiqV/component
...
import sty from "./PlasmicTagsRow.module.css"; // plasmic-import: QiKny2-oAX-B/css
...
export type PlasmicTagsRow__VariantMembers = {};
export type PlasmicTagsRow__VariantsArgs = {};
type VariantPropType = keyof PlasmicTagsRow__VariantsArgs;
export const PlasmicTagsRow__VariantProps = new Array<VariantPropType>();

export type PlasmicTagsRow__ArgsType = {
  items?: any;
...
type ArgPropType = keyof PlasmicTagsRow__ArgsType;
export const PlasmicTagsRow__ArgProps = new Array<ArgPropType>(
  "items",
  "onClick",
  "selectedSort",
  "onDelete",
...
export type PlasmicTagsRow__OverridesType = {
  root?: Flex__<"div">;
  tagsRowSingleTagItem?: Flex__<typeof TagsRowSingleTagItem>;
...
export interface DefaultTagsRowProps {
  items?: any;
  onClick?: (name: string, value: string) => void;
  selectedSort?: string;
  onDelete?: (name: string, value: string) => void;
...
function PlasmicTagsRow__RenderFunc(props: {
  variants: PlasmicTagsRow__VariantsArgs;
  args: PlasmicTagsRow__ArgsType;
  overrides: PlasmicTagsRow__OverridesType;
  forNode?: string;
}) {
  ...
  return (
    ...
    >
      {(() => {
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__zk3SA)}
          style={{ width: "100%" }}
        >
          <div
            className={classNames(
          ...
          >
            {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
              ...
              return (
                <TagsRowSingleTagItem
                  data-plasmic-name={"tagsRowSingleTagItem"}
                  data-plasmic-override={overrides.tagsRowSingleTagItem}
                  className={classNames(
                    "__wab_instance",
                    sty.tagsRowSingleTagItem
                  )}
                  key={currentIndex}
                  label={(() => {
                    try {
                    ...
                    <FilterRowSingle
                      ...
                      onClick={async name => {
                        ...
                        if (
                          ...
                          $steps["openSortDialog"] = await $steps[
                            "openSortDialog"
                          ];
                        }

                        $steps["toggleSwitch"] =
                          $props.items.filters?.find(
                        ...
                        if (
                          ...
                          typeof $steps["updateOptionsDialogOpen"] ===
                            "object" &&
          ...
          <Dialog
            ...
            body={
              <div className={classNames(projectcss.all, sty.freeBox__e93GL)}>
                <div
                  className={classNames(projectcss.all, sty.freeBox___3U7Q5)}
                >
                  <div
                    className={classNames(projectcss.all, sty.freeBox___31IDc)}
                    onClick={async event => {
                      const $steps = {};
                ...
                <div className={classNames(projectcss.all, sty.freeBox__qmmDb)}>
                  <Button
                    children2={
                      <React.Fragment>
                        {(() => {
                    ...
                    className={classNames("__wab_instance", sty.button__c2FU)}
                    loading={(() => {
                      try {
                  ...
                  <Button
                    ...
                    className={classNames("__wab_instance", sty.button___79XDt)}
                    color={"text"}
                    onClick={async event => {
                      const $steps = {};
      ...
      {(() => {
        ...
        >
          {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
            ...
            return (
              <div
                className={classNames(projectcss.all, sty.freeBox__sfFQg)}
                key={currentIndex}
                onClick={async event => {
                  const $steps = {};
...
const PlasmicDescendants = {
  ...
  tagsRowSingleTagItem: ["tagsRowSingleTagItem"],
...
type NodeDefaultElementType = {
  root: "div";
  tagsRowSingleTagItem: typeof TagsRowSingleTagItem;
...
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicTagsRow__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    // Specify args directly as props
    Omit<PlasmicTagsRow__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicTagsRow__ArgProps,
          internalVariantPropNames: PlasmicTagsRow__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicTagsRow__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicTagsRow";
  } else {
    func.displayName = `PlasmicTagsRow.${nodeName}`;
  }
  return func;
}

export const PlasmicTagsRow = Object.assign(
  // Top-level PlasmicTagsRow renders the root element
  makeNodeComponent("root"),
  {
    // Helper components rendering sub-elements
    tagsRowSingleTagItem: makeNodeComponent("tagsRowSingleTagItem"),
    ...
    // Metadata about props expected for PlasmicTagsRow
    internalVariantProps: PlasmicTagsRow__VariantProps,
    internalArgProps: PlasmicTagsRow__ArgProps
  }
);

export default PlasmicTagsRow;
/* prettier-ignore-end */
