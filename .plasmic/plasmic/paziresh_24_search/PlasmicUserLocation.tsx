...
import sty from "./PlasmicUserLocation.module.css"; // plasmic-import: YoStZ8eQd9r-/css
...
export type PlasmicUserLocation__VariantMembers = {};
export type PlasmicUserLocation__VariantsArgs = {};
type VariantPropType = keyof PlasmicUserLocation__VariantsArgs;
export const PlasmicUserLocation__VariantProps = new Array<VariantPropType>();

export type PlasmicUserLocation__ArgsType = {
...
export type PlasmicUserLocation__OverridesType = {
  root?: Flex__<"div">;
  setUserCityStateVarByCookieIfExist?: Flex__<typeof SideEffect>;
...
export interface DefaultUserLocationProps {
  setCityByUsersIp?: boolean;
  requestGeolocationAccess?: boolean;
  givLocationButtonLoadingStatus?: boolean;
  onUserCityChange?: (val: string) => void;
...
function PlasmicUserLocation__RenderFunc(props: {
  variants: PlasmicUserLocation__VariantsArgs;
  args: PlasmicUserLocation__ArgsType;
  overrides: PlasmicUserLocation__OverridesType;
  forNode?: string;
}) {
  ...
  return (
    ...
    >
              ...
              __html: (() => {
                try {
                  ...
                  if (
                    ...
                    return "\u0646\u062a\u0627\u06cc\u062c \u062c\u0633\u062a\u062c\u0648 \u0628\u0631 \u0627\u0633\u0627\u0633 \u0634\u0647\u0631 \u06cc\u0632\u062f \u0627\u0648\u0644\u0648\u06cc\u062a \u067e\u06cc\u062f\u0627 \u0645\u06cc\u200c\u06a9\u0646\u0646\u062f.";
                  }
                  throw e;
                }
              })()
      ...
      <SideEffect
        data-plasmic-name={"setUserCityStateVarByCookieIfExist"}
        data-plasmic-override={overrides.setUserCityStateVarByCookieIfExist}
        className={classNames(
          "__wab_instance",
          sty.setUserCityStateVarByCookieIfExist
        )}
        onMount={async () => {
          const $steps = {};

          $steps["transferCityDataFromNewCityCookieToLocalstorage"] = true
            ? (() => {
                const actionArgs = {
                  customFunction: async () => {
                    return (function () {
                      function getCookieValue(name) {
                        ...
                        console.log(
                          `Cookie parts after splitting by ${name}:`,
                          parts
                        );
                        if (parts.length >= 2) {
                          const cookieValue = parts.pop().split(";").shift();
                          console.log(
                            `Found cookie "${name}" with value:`,
                            cookieValue
                          );
                          return cookieValue;
                        } else {
                      ...
                      const newCityCookieValue = getCookieValue("new-city");
                      console.log("newCityCookieValue:", newCityCookieValue);
                      if (newCityCookieValue) {
                        try {
                          const decodedValue =
                            decodeURIComponent(newCityCookieValue);
                          console.log("decodedValue:", decodedValue);
                          const cityData = JSON.parse(decodedValue);
                          console.log("cityData:", cityData);
                          const newCityId = cityData.id.toString();
                          console.log("newCityId:", newCityId);
                          const searchUserCityDataString =
                            localStorage.getItem("search_user_city");
                          console.log(
                            "searchUserCityDataString from localStorage:",
                            searchUserCityDataString
                          );
                          let searchUserCityId = null;
                          if (searchUserCityDataString) {
                            try {
                              const searchUserCityData = JSON.parse(
                                searchUserCityDataString
                              );
                              searchUserCityId =
                                searchUserCityData.id.toString();
                              console.log(
                                "Parsed searchUserCityData:",
                                searchUserCityData
                              );
                            } catch (e) {
                              console.error(
                                "Error parsing search_user_city from localStorage:",
                                e
                              );
                            }
                          }
                          console.log("searchUserCityId:", searchUserCityId);
                          if (searchUserCityId !== newCityId) {
                            console.log(
                              "IDs are different, updating search_user_city"
                            );
                            ...
                            console.log("IDs are the same, no update needed");
                          }
                        } catch (e) {
                          console.error("Error parsing new-city cookie:", e);
                        }
                      } else {
                        console.log(
                          "new-city cookie does not exist or has no value"
                        );
                      }
                    })();
                  }
            ...
            : undefined;
          if (
            $steps["transferCityDataFromNewCityCookieToLocalstorage"] != null &&
            typeof $steps["transferCityDataFromNewCityCookieToLocalstorage"] ===
              "object" &&
            typeof $steps["transferCityDataFromNewCityCookieToLocalstorage"]
              .then === "function"
          ) {
            $steps["transferCityDataFromNewCityCookieToLocalstorage"] =
              await $steps["transferCityDataFromNewCityCookieToLocalstorage"];
          }

          $steps["updateUserCityStateVar"] =
            localStorage.getItem("search_user_city") !== null &&
            localStorage.getItem("search_user_city") !== ""
              ? (() => {
                  const actionArgs = {
                    variable: {
              ...
              : undefined;
          if (
            $steps["updateUserCityStateVar"] != null &&
          ...
          <React.Fragment>
            ...
            >
              <Button
                ...
                endIcon={
                  <ChevronLeftIcon
                    className={classNames(projectcss.all, sty.svg__sUamd)}
                    role={"img"}
                  />
                }
                loading={(() => {
                ...
                startIcon={
                  <ChevronRightIcon
                    className={classNames(projectcss.all, sty.svg__i3Xxk)}
                    role={"img"}
                  />
                }
              />
              ...
              <Button
                ...
                endIcon={
                  <ChevronLeftIcon
                    className={classNames(projectcss.all, sty.svg__hsnO9)}
                    role={"img"}
                  />
                }
                onClick={async event => {
                ...
                startIcon={
                  <ChevronRightIcon
                    className={classNames(projectcss.all, sty.svg__xMDsF)}
                    role={"img"}
                  />
                }
              />
...
const PlasmicDescendants = {
  root: [
    "root",
    "setUserCityStateVarByCookieIfExist",
    "dialog",
    "freeBox",
    "useMyLocation",
    "button",
  ...
  setUserCityStateVarByCookieIfExist: ["setUserCityStateVarByCookieIfExist"],
  dialog: ["dialog", "freeBox", "useMyLocation", "button"],
...
type NodeDefaultElementType = {
  root: "div";
  setUserCityStateVarByCookieIfExist: typeof SideEffect;
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicUserLocation__OverridesType,
  DescendantsType<T>
>;
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicUserLocation__ArgProps,
          internalVariantPropNames: PlasmicUserLocation__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicUserLocation__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicUserLocation";
  } else {
    func.displayName = `PlasmicUserLocation.${nodeName}`;
  }
  return func;
}

export const PlasmicUserLocation = Object.assign(
  // Top-level PlasmicUserLocation renders the root element
  makeNodeComponent("root"),
  {
    // Helper components rendering sub-elements
    setUserCityStateVarByCookieIfExist: makeNodeComponent(
      "setUserCityStateVarByCookieIfExist"
    ),
    ...
    // Metadata about props expected for PlasmicUserLocation
    internalVariantProps: PlasmicUserLocation__VariantProps,
    internalArgProps: PlasmicUserLocation__ArgProps
  }
);

export default PlasmicUserLocation;
/* prettier-ignore-end */
