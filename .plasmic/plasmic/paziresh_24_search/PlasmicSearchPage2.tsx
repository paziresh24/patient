...
export type PlasmicSearchPage2__OverridesType = {
  root?: Flex__<'div'>;
  paziresh24LayoutWithHeaderAndFooter?: Flex__<typeof LayoutWithHeaderAndFooter>;
  freeBox?: Flex__<'div'>;
  text?: Flex__<'div'>;
          ...
          (() => {
            try {
              return typeof window === 'undefined'
                ? {}
                : Object.fromEntries(
                    Array.from(new window.URLSearchParams(window.location.search))
                      .filter(([k]) => k !== 'text')
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <meta key="og:title" property="og:title" content={PlasmicSearchPage2.pageMetadata.title} />
        <meta key="twitter:title" name="twitter:title" content={PlasmicSearchPage2.pageMetadata.title} />
      </Head>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <LayoutWithHeaderAndFooter
            ...
            data-plasmic-override={overrides.paziresh24LayoutWithHeaderAndFooter}
            className={classNames('__wab_instance', sty.paziresh24LayoutWithHeaderAndFooter)}
            compactFooter={true}
            ...
            >
              ...
              <Suggestion
                ...
                onSelect={async searchQuery => {
                  ...
                  if (
                    ...
                    typeof $steps['updateMainSearchRequestResult'] === 'object' &&
                    typeof $steps['updateMainSearchRequestResult'].then === 'function'
                  ) {
                    $steps['updateMainSearchRequestResult'] = await $steps['updateMainSearchRequestResult'];
                  }
                  ...
                  if (
                    ...
                    typeof $steps['updateMainSearchRequestPage'].then === 'function'
                  ) {
                    $steps['updateMainSearchRequestPage'] = await $steps['updateMainSearchRequestPage'];
                  }
                }}
                onSuggestionInputInputQueryTextChange={async (...eventArgs: any) => {
                  generateStateOnChangeProp($state, ['suggestion', 'suggestionInputInputQueryText']).apply(null, eventArgs);

                  if (eventArgs.length > 1 && eventArgs[1] && eventArgs[1]._plasmic_state_init_) {
                    return;
                  }
                }}
                onSuggestionInputTextInputValueChange={async (...eventArgs: any) => {
                  generateStateOnChangeProp($state, ['suggestion', 'suggestionInputTextInputValue']).apply(null, eventArgs);

                  if (eventArgs.length > 1 && eventArgs[1] && eventArgs[1]._plasmic_state_init_) {
                    return;
                  }
                }}
                suggestionInputInputQueryText={generateStateValueProp($state, ['suggestion', 'suggestionInputInputQueryText'])}
              />
              ...
              {(() => {
                const child$Props = {
                  ...
                  onSelectedChange: async (...eventArgs: any) => {
                    generateStateOnChangeProp($state, ['searchFilters', 'selected']).apply(null, eventArgs);
                  ...
                  selected: generateStateValueProp($state, ['searchFilters', 'selected']),
                };
                ...
                return (
                  <SearchFilters data-plasmic-name={'searchFilters'} data-plasmic-override={overrides.searchFilters} {...child$Props} />
                );
              })()}
              <UserLocation
                ...
                onUserCityChange={async (...eventArgs: any) => {
                  generateStateOnChangeProp($state, ['userLocation', 'userCity']).apply(null, eventArgs);
              ...
              <MainSearchRequest
                ...
                onApiRequestDataChange={async (...eventArgs: any) => {
                  generateStateOnChangeProp($state, ['mainSearchRequest', 'apiRequestData']).apply(null, eventArgs);
                ...
                onPageChange2={async (...eventArgs: any) => {
                  generateStateOnChangeProp($state, ['mainSearchRequest', 'page']).apply(null, eventArgs);
                    ...
                    $steps['goToPage'] = false
                      ? (() => {
                          const actionArgs = {
                            destination: (() => {
                              try {
                                return `/s/jahannama/?text=${$ctx.query?.text ?? ''}${Object.entries($state.searchFilters.selected).reduce(
                                  (acc, item) => {
                                    acc += `&${item[0]}=${JSON.stringify(item[1])}`;
                                    return acc;
                                  },
                ...
                onResultChange2={async (...eventArgs: any) => {
                  generateStateOnChangeProp($state, ['mainSearchRequest', 'result']).apply(null, eventArgs);

                  if (eventArgs.length > 1 && eventArgs[1] && eventArgs[1]._plasmic_state_init_) {
                    return;
                  }
                }}
                page={generateStateValueProp($state, ['mainSearchRequest', 'page'])}
                result={generateStateValueProp($state, ['mainSearchRequest', 'result'])}
                searchFilters={(() => {
                  try {
                    return typeof window === 'undefined'
                      ? {}
                ...
                searchQuery={(() => {
                  try {
                    return $state.suggestion.suggestionInputInputQueryText ? $state.suggestion.suggestionInputInputQueryText : '';
                  } catch (e) {
                    if (e instanceof TypeError || e?.plasmicType === 'PlasmicUndefinedDataError') {
                      return undefined;
                    }
          ...
          <SideEffect
            ...
            className={classNames('__wab_instance', sty.runGtmAndMetricaSideEffect)}
            onMount={async () => {
              const $steps = {};
    ...
    ym(98010713, "init", {
        ...
        webvisor:true
                              ...
                              if (!document.querySelector('noscript img[src*="mc.yandex.ru/watch"]')) {
...
const PlasmicDescendants = {
  ...
  freeBox: ['freeBox', 'text', 'suggestion', 'searchFilters', 'userLocation', 'mainSearchRequest'],
  text: ['text'],
...
type NodeOverridesType<T extends NodeNameType> = Pick<PlasmicSearchPage2__OverridesType, DescendantsType<T>>;
...
export const PlasmicSearchPage2 = Object.assign(
  ...
  makeNodeComponent('root'),
  {
    ...
    paziresh24LayoutWithHeaderAndFooter: makeNodeComponent('paziresh24LayoutWithHeaderAndFooter'),
