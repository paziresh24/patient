...
import sty from "./PlasmicHamdastK6ZwKcaHfkxemp7YqC1VbY.module.css"; // plasmic-import: 6-Wp84uf7hB4/css
...
export type PlasmicHamdastK6ZwKcaHfkxemp7YqC1VbY__VariantMembers = {};
export type PlasmicHamdastK6ZwKcaHfkxemp7YqC1VbY__VariantsArgs = {};
type VariantPropType = keyof PlasmicHamdastK6ZwKcaHfkxemp7YqC1VbY__VariantsArgs;
export const PlasmicHamdastK6ZwKcaHfkxemp7YqC1VbY__VariantProps =
  new Array<VariantPropType>();

export type PlasmicHamdastK6ZwKcaHfkxemp7YqC1VbY__ArgsType = { data?: any };
type ArgPropType = keyof PlasmicHamdastK6ZwKcaHfkxemp7YqC1VbY__ArgsType;
export const PlasmicHamdastK6ZwKcaHfkxemp7YqC1VbY__ArgProps =
  new Array<ArgPropType>("data");

export type PlasmicHamdastK6ZwKcaHfkxemp7YqC1VbY__OverridesType = {
  root?: Flex__<"div">;
  collapsible?: Flex__<typeof Collapsible>;
};

export interface DefaultHamdastK6ZwKcaHfkxemp7YqC1VbYProps {
  data?: any;
  className?: string;
}
...
function PlasmicHamdastK6ZwKcaHfkxemp7YqC1VbY__RenderFunc(props: {
  variants: PlasmicHamdastK6ZwKcaHfkxemp7YqC1VbY__VariantsArgs;
  args: PlasmicHamdastK6ZwKcaHfkxemp7YqC1VbY__ArgsType;
  overrides: PlasmicHamdastK6ZwKcaHfkxemp7YqC1VbY__OverridesType;
  forNode?: string;
}) {
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicHamdastK6ZwKcaHfkxemp7YqC1VbY__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    PlasmicHamdastK6ZwKcaHfkxemp7YqC1VbY__VariantsArgs,
    ReservedPropsType
  > &
    /* Specify args directly as props*/ Omit<
      PlasmicHamdastK6ZwKcaHfkxemp7YqC1VbY__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicHamdastK6ZwKcaHfkxemp7YqC1VbY__ArgProps,
          internalVariantPropNames:
            PlasmicHamdastK6ZwKcaHfkxemp7YqC1VbY__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicHamdastK6ZwKcaHfkxemp7YqC1VbY__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicHamdastK6ZwKcaHfkxemp7YqC1VbY";
  } else {
    func.displayName = `PlasmicHamdastK6ZwKcaHfkxemp7YqC1VbY.${nodeName}`;
  }
  return func;
}

export const PlasmicHamdastK6ZwKcaHfkxemp7YqC1VbY = Object.assign(
  // Top-level PlasmicHamdastK6ZwKcaHfkxemp7YqC1VbY renders the root element
  makeNodeComponent("root"),
  {
    // Helper components rendering sub-elements
    collapsible: makeNodeComponent("collapsible"),

    // Metadata about props expected for PlasmicHamdastK6ZwKcaHfkxemp7YqC1VbY
    internalVariantProps: PlasmicHamdastK6ZwKcaHfkxemp7YqC1VbY__VariantProps,
    internalArgProps: PlasmicHamdastK6ZwKcaHfkxemp7YqC1VbY__ArgProps
  }
);

export default PlasmicHamdastK6ZwKcaHfkxemp7YqC1VbY;
/* prettier-ignore-end */
