...
function PlasmicServices__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <Stack__ as={'div'} hasGap={true} className={classNames(projectcss.all, sty.freeBox___2Q2QS)}>
          <PlasmicIcon__
              ...
              {(
                ...
                <Stack__
                  ...
                  className={classNames(projectcss.all, sty.freeBox__zcaIc, {
                    [sty.freeBoxtype_onlineVisit__zcaIc7QAlK]: hasVariant($state, 'type', 'onlineVisit'),
                  })}
                >
                  <WhatsappsvgIcon
                    className={classNames(projectcss.all, sty.svg___9I5Wv, {
                      [sty.svgtype_onlineVisit___9I5Wv7QAlK]: hasVariant($state, 'type', 'onlineVisit'),
                    })}
                    role={'img'}
                  />

                  <div
                    className={classNames(projectcss.all, projectcss.__wab_text, sty.text__z3K8S, {
                      [sty.texttype_onlineVisit__z3K8S7QAlK]: hasVariant($state, 'type', 'onlineVisit'),
                    })}
                  >
                    {'\u0648\u0627\u062a\u0633\u0627\u067e'}
                  </div>
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    /* Specify args directly as props*/ Omit<PlasmicServices__ArgsType, ReservedPropsType> &
