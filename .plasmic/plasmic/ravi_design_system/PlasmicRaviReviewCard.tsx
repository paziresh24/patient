...
export type PlasmicRaviReviewCard__ArgsType = {
  ...
  avgRateValue?: number;
  commentText?: string;
  onSendReport?: (value: string, id: string) => void;
  feedBackId?: string;
  replies?: any;
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <RaviReviewOptions
            ...
            isLoading={(() => {
              try {
                return $props.isLoadingSendReport;
              } catch (e) {
                if (
                  e instanceof TypeError ||
                  e?.plasmicType === "PlasmicUndefinedDataError"
      ...
      {(() => {
        ...
        <RaviReviewReply
          className={classNames("__wab_instance", sty.raviReviewReply__lfMpp)}
          commentText={(() => {
            try {
              return $props.replies?.[0].description != "undefined"
                ? $props.replies?.[0].description || ""
                : "";
            } catch (e) {
              if (
                e instanceof TypeError ||
          ...
          userName={(() => {
            try {
              return $props.replies?.[0].user_display_name || "کاربر بدون نام";
            } catch (e) {
              if (
                e instanceof TypeError ||
                e?.plasmicType === "PlasmicUndefinedDataError"
      ...
      <Paziresh24Dialog
        ...
        body={
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__zQg7M)}
          >
            {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
              (() => {
                try {
                ...
                <RaviReviewReply
                  ...
                  onSendReport={async value => {
                    ...
                    if (
                      ...
                      $steps["runOnSendReport"] = await $steps[
                        "runOnSendReport"
                      ];
                    }
                  }}
                  userName={(() => {
                    try {
                      return currentItem.user_display_name || "کاربر بدون نام";
                    } catch (e) {
                      if (
                        e instanceof TypeError ||
                        e?.plasmicType === "PlasmicUndefinedDataError"
