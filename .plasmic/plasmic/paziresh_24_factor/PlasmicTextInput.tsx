...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: gwWZcNwcxOfS/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__qq2Il)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__bnooe)}
              role={"img"}
            />
          ),
