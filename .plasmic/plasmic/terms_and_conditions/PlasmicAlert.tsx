...
import sty from "./PlasmicAlert.module.css"; // plasmic-import: dvBpky5d8iP9/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__xAinl, {
          [sty.freeBoxnoBody__xAinljLnhh]: hasVariant(
            $state,
            "noBody",
            "noBody"
          ),
          [sty.freeBoxnoHeader__xAinlmqAoq]: hasVariant(
            $state,
            "noHeader",
            "noHeader"
          ),
          [sty.freeBoxnoIcon__xAinlgh4W1]: hasVariant(
            $state,
            "noIcon",
            "noIcon"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__vgxW6, {
            [sty.freeBoxnoIcon__vgxW6Gh4W1]: hasVariant(
              $state,
              "noIcon",
              "noIcon"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__tiueo)}
                role={"img"}
              />
            ),
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__bLhyn, {
            [sty.freeBoxnoHeader__bLhynmqAoq]: hasVariant(
              $state,
              "noHeader",
              "noHeader"
            ),
            [sty.freeBoxnoIcon__bLhyngh4W1]: hasVariant(
              $state,
              "noIcon",
              "noIcon"
            )
        ...
        >
          ...
          <div
            className={classNames(projectcss.all, sty.freeBox__y7AU, {
              [sty.freeBoxnoBody__y7AUjLnhh]: hasVariant(
                $state,
                "noBody",
                "noBody"
              ),
              [sty.freeBoxnoHeader__y7AUmqAoq]: hasVariant(
                $state,
                "noHeader",
                "noHeader"
              )
