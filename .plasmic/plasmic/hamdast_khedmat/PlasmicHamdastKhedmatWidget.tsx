      ...
      <Paziresh24Modal
        ...
        body={
          <DataFetcher
            ...
            noLayout={false}
            url={
              "https://mahya-n8n.darkube.app/webhook/servises?user_id=12487631"
            }
          >
            <DataCtxReader__>
              {$ctx =>
                        ...
                        >
                          ...
                          >
                            <React.Fragment>
                              {(() => {
                                try {
                                  return $ctx.fetchedData[currentIndex].service;
                                } catch (e) {
                                  if (
                                    e instanceof TypeError ||
                                    e?.plasmicType ===
                                ...
                                {(() => {
                                  try {
                                    return null ==
                                      ...
                                      : $ctx.fetchedData[currentIndex].price_min
                                      ? Number(
                                          $ctx.fetchedData[currentIndex]
                                            .price_min
...
const PlasmicDescendants = {
  root: ["root", "paziresh24Button", "modal", "httpRestApiFetcher"],
  paziresh24Button: ["paziresh24Button"],
  modal: ["modal", "httpRestApiFetcher"],
