...
export type PlasmicProfileActions2__VariantMembers = {};
export type PlasmicProfileActions2__VariantsArgs = {};
type VariantPropType = keyof PlasmicProfileActions2__VariantsArgs;
export const PlasmicProfileActions2__VariantProps =
  new Array<VariantPropType>();

export type PlasmicProfileActions2__ArgsType = {
  slug?: string;
  hideSave?: boolean;
  hideShare?: boolean;
  hideReport?: boolean;
};
type ArgPropType = keyof PlasmicProfileActions2__ArgsType;
export const PlasmicProfileActions2__ArgProps = new Array<ArgPropType>(
  "slug",
  "hideSave",
  "hideShare",
  "hideReport"
...
export type PlasmicProfileActions2__OverridesType = {
  root?: Flex__<"div">;
  getIsBookedMark?: Flex__<typeof ApiRequest>;
};

export interface DefaultProfileActions2Props {
  slug?: string;
  hideSave?: boolean;
  hideShare?: boolean;
  hideReport?: boolean;
...
function PlasmicProfileActions2__RenderFunc(props: {
  variants: PlasmicProfileActions2__VariantsArgs;
  args: PlasmicProfileActions2__ArgsType;
  overrides: PlasmicProfileActions2__OverridesType;
  forNode?: string;
}) {
              ...
              children2={
                ...
                >
                  {(() => {
                    ...
                    <IconIcon
                      className={classNames(projectcss.all, sty.svg__atoCv)}
                      role={"img"}
                    />
                  ) : null}
                  <div
                  ...
                  {(() => {
                    ...
                    <Icon8Icon
                      className={classNames(projectcss.all, sty.svg__xquhK)}
                      role={"img"}
                    />
                  ) : null}
                </Stack__>
            ...
            children2={
              ...
              >
                {(() => {
                  ...
                  <IconIcon
                    className={classNames(projectcss.all, sty.svg___7ChE)}
                    role={"img"}
                  />
                ) : null}
                <div
                ...
                {(() => {
                  ...
                  <Icon8Icon
                    className={classNames(projectcss.all, sty.svg__mKLz)}
                    role={"img"}
                  />
                ) : null}
              </Stack__>
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicProfileActions2__OverridesType,
  DescendantsType<T>
>;
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicProfileActions2__ArgProps,
          internalVariantPropNames: PlasmicProfileActions2__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicProfileActions2__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicProfileActions2";
  } else {
    func.displayName = `PlasmicProfileActions2.${nodeName}`;
  }
  return func;
}

export const PlasmicProfileActions2 = Object.assign(
  // Top-level PlasmicProfileActions2 renders the root element
  makeNodeComponent("root"),
  {
    // Helper components rendering sub-elements
    getIsBookedMark: makeNodeComponent("getIsBookedMark"),

    // Metadata about props expected for PlasmicProfileActions2
    internalVariantProps: PlasmicProfileActions2__VariantProps,
    internalArgProps: PlasmicProfileActions2__ArgProps
  }
);

export default PlasmicProfileActions2;
/* prettier-ignore-end */
