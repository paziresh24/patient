...
import sty from "./PlasmicButton.module.css"; // plasmic-import: FbWUiNE2W7pg/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: CXp1JfQK09UO/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: QYS_su5_pZze/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__yfohH)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__u8Dhu)}
                role={"img"}
              />
            ),
