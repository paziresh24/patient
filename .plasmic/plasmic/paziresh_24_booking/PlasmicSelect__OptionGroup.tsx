...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: sSC8KTy3a6Hh/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: D_54gPqAw9rb/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__vaOVs)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__x1Edt)}
              />
            </React.Fragment>
          ),
          value: args.children
