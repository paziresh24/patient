                          ...
                          children2={
                            hasVariant(
                              ...
                              <React.Fragment>
                                {(() => {
                                  try {
                                    return $ctx.schedules[0].services[0].title;
                                  } catch (e) {
                                    if (
                                      e instanceof TypeError ||
                                      e?.plasmicType ===
...
const PlasmicDescendants = {
  root: ["root", "dialog", "httpRestApiFetcher", "popoverCore"],
  dialog: ["dialog", "httpRestApiFetcher", "popoverCore"],
  httpRestApiFetcher: ["httpRestApiFetcher", "popoverCore"],
