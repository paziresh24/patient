  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox___0OFb)}>
        ...
        <Stack__ as={'div'} hasGap={true} className={classNames(projectcss.all, sty.freeBox__a2ONy)}>
      ...
      {(() => {
        ...
        <Collapsible
          ...
          slot2={
            <Stack__ as={'div'} hasGap={true} className={classNames(projectcss.all, sty.freeBox__wvxjo)}>
...
type NodeOverridesType<T extends NodeNameType> = Pick<PlasmicAddressesCard__OverridesType, DescendantsType<T>>;
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    /* Specify args directly as props*/ Omit<PlasmicAddressesCard__ArgsType, ReservedPropsType> &
