    ...
    <div className="max-w-screen-xl min-h-[70vh] md:grid md:grid-cols-12 mx-auto md:mt-10 md:space-s-8">
      <div className="bg-white md:sticky md:top-10 col-span-3 h-fit md:pb-2 rounded-lg shadow-sm px-5 hidden md:block">
        ...
        <div className="flex overflow-auto space-s-5 md:space-s-0 md:flex-col">
          <Link href="/patient/appointments" className="py-4 flex items-center space-s-3 whitespace-nowrap">
            <CalenderIcon />
            <Text fontWeight="medium">{t('menu.myTurns')}</Text>
          </Link>
          <Link href="/patient/bookmarks" className="py-4 flex items-center space-s-3 whitespace-nowrap">
            <BookmarkIcon />
            <Text fontWeight="medium">{t('menu.bookmarks')}</Text>
          </Link>
          <Link href="/patient/subuser" className="py-4 flex items-center space-s-3 whitespace-nowrap">
            <UsersIcon />
