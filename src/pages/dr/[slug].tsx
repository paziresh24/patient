...
const DoctorProfile = (props: any) => {
  ...
  }, [isBulk, information, slug, userInfo, shouldUseIncrementPageView, incrementPageView, addPageView, recommendEvent, setProfileData, centers, expertises, history, feedbacks]);
