      ...
      {!pending &&
        (isLogin ? (
          <div ref={ref} className="relative flex items-center" onClick={() => setOpen(!open)}>
            ...
            <div
              className={`absolute shadow-md left-[0] min-w-full text-slate-700 font-medium whitespace-nowrap z-50 py-3 px-2 overflow-auto bg-white border border-slate-300 rounded-2xl max-w-xs w-max  top-16 md:ml-0 ${
                open ? 'block' : 'hidden'
              }`}
            >
