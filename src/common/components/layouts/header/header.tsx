...
const Header = (props: HeaderProps) => {
  ...
  return (
    <>
      ...
      <header className="print:hidden flex items-center h-16 px-3 text-lg bg-white border-b border-solid shadow-sm z-infinity text-slate-700 md:px-4 md:h-20 border-slate-100">
