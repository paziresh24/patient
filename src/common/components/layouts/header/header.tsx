...
const Header = (props: HeaderProps) => {
  ...
  return (
    <>
      ...
      <header className="z-50 flex items-center min-h-16 h-16 px-3 text-lg bg-white border-b border-solid shadow-sm print:hidden pwa:hidden text-slate-700 md:px-4 md:min-h-20 md:h-20 border-slate-100">
